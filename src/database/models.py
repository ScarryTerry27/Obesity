...
class SliceT1(Base):
    ...
    map = Column(Float, nullable=True)
    map_min = Column(Float, nullable=True)
    map_max = Column(Float, nullable=True)
    spo2 = Column(Float, nullable=True)
    urine_ml_per_h = Column(Float, nullable=True)
    hemoglobin = Column(Float, nullable=True)
...
class SliceT3(Base):
    ...
    mv = Column(Float, nullable=True)
    peep = Column(Float, nullable=True)
    ppik = Column(Float, nullable=True)
    rplato = Column(Float, nullable=True)
    delta_p = Column(Float, nullable=True)
    cstat = Column(Float, nullable=True)
    cdyn = Column(Float, nullable=True)
    uzl_score = Column(Float, nullable=True)
    mac = Column(Float, nullable=True)
    qcon = Column(Float, nullable=True)
    qnox = Column(Float, nullable=True)
    emg = Column(Float, nullable=True)
    pn_arterial = Column(Float, nullable=True)
    be_arterial = Column(Float, nullable=True)
    hco3_arterial = Column(Float, nullable=True)
    lactate_arterial = Column(Float, nullable=True)
    pao2 = Column(Float, nullable=True)
...
class SliceT4(Base):
    """Table for slice T4 data after gas insufflation."""
...
class SliceT6(Base):
    """Table for slice T6 data during the main stage of operation."""
...
class SliceT7(Base):
    """Table for slice T7 data after desufflation of abdominal gas."""
...
class SliceT8(Base):
    """Table for slice T8 data immediately after tracheal extubation."""
    ...
    cold_test = Column(Boolean, nullable=True)
    motor_block = Column(Boolean, nullable=True)
    t_operation = Column(Float, nullable=True)
    t_awakening = Column(Float, nullable=True)
    t_before_extubation = Column(Float, nullable=True)
    infusion_volume = Column(Float, nullable=True)
    polo = Column(Boolean, nullable=True)
    phrenic_syndrome = Column(Boolean, nullable=True)
    phrenic_crsh = Column(Boolean, nullable=True)
    aki = Column(Boolean, nullable=True)
...
class SliceT10(Base):
    """Data for slice T11 (end of first postoperative day)."""
